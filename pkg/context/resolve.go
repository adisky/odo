...
func (o *Context) resolveProject(localConfiguration envinfo.LocalConfigProvider) {
...
func (o *Context) resolveNamespace(configProvider envinfo.LocalConfigProvider) {
	var namespace string
	command := o.command
	projectFlag := FlagValueIfSet(command, ProjectFlagName)
	if len(projectFlag) > 0 {
...
func (o *Context) resolveApp(createAppIfNeeded bool, localConfiguration envinfo.LocalConfigProvider) {
	var app string
	command := o.command
...
func (o *Context) resolveAndSetComponent(command *cobra.Command, localConfiguration envinfo.LocalConfigProvider) string {
	var cmp string
